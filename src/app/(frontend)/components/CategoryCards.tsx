    ...
    <div className="space-y-8" dir={langConfig.direction} style={{ fontFamily: langConfig.font }}>
      ...
      <div className="flex justify-between items-center">
        ...
        <Link
          ...
          className="inline-flex items-center px-2 py-1.5 bg-indigo-600 border-2 rounded-full text-sm  text-white hover:bg-indigo-500 transition-all active:translate-x-0.5 active:translate-y-0.5"
        >
          {t.allCategories}
          {langConfig.direction === 'rtl' ? (
            <LucideArrowLeft size={16} className="mr-1" />
