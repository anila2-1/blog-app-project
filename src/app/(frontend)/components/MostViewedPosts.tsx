...
const MostViewedPosts: React.FC<MostViewedPostsProps> = memo(({ posts, loading }) => {
  /* Skeleton (same as LatestPosts) */
  if (loading) {
    return (
        ...
        const content = (
          ...
          >
            ...
            {imageUrl ? (
              ...
              <div className="w-16 h-12 sm:w-18 sm:h-14 rounded-lg bg-gray-200 shrink-0" />
            )}
