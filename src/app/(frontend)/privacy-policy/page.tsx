...
const translations = {
  ...
  el: {
    heroTitle: 'Πολιτική Απορρήτου',
    heroDesc:
      'Το απόρρητό σας είναι σημαντικό για εμάς. Μάθετε πώς συλλέγουμε, χρησιμοποιούμε και προστατεύουμε τα προσωπικά σας δεδομένα.',
    learnMore: 'Μάθετε Περισσότερα',
    contact: 'Επικοινωνία',

    infoTitle: 'Πληροφορίες που Συλλέγουμε',
    infoDesc:
      'Συλλέγουμε πληροφορίες που μας παρέχετε άμεσα, όπως όταν δημιουργείτε λογαριασμό ή επικοινωνείτε με την υποστήριξη.',
    infoList: [
      'Προσωπικά στοιχεία (όνομα, email, αριθμός τηλεφώνου)',
      'Στοιχεία σύνδεσης λογαριασμού',
      'Προτιμήσεις επικοινωνίας',
      'Δεδομένα χρήσης και αναλύσεις',
    ],

    secure: 'Ασφαλής Αποθήκευση',
    secureDesc: 'Τα δεδομένα σας κρυπτογραφούνται και αποθηκεύονται με ασφάλεια',
    minimal: 'Ελάχιστη Συλλογή',
    minimalDesc: 'Συλλέγουμε μόνο ό,τι είναι απαραίτητο',

    usageTitle: 'Πώς Χρησιμοποιούμε τις Πληροφορίες σας',
    usageDesc:
      'Οι πληροφορίες σας μάς βοηθούν να παρέχουμε καλύτερες υπηρεσίες, να βελτιώνουμε την πλατφόρμα μας και να επικοινωνούμε αποτελεσματικά μαζί σας.',
    usageList: [
      'Παροχή και συντήρηση των υπηρεσιών μας',
      'Αποστολή ενημερώσεων και ενημερωτικών δελτίων',
      'Απάντηση στα ερωτήματά σας',
      'Ανάλυση προτύπων χρήσης',
    ],

    shareTitle: 'Κοινοποίηση Δεδομένων',
    shareDesc:
      'Δεν πωλούμε, ανταλλάσσουμε ή μεταβιβάζουμε με άλλο τρόπο τα προσωπικά σας δεδομένα σε τρίτους χωρίς τη συγκατάθεσή σας, εκτός από τις περιπτώσεις που περιγράφονται στην παρούσα πολιτική.',
    shareDesc2:
      'Ενδέχεται να κοινοποιούμε πληροφορίες σε αξιόπιστους παρόχους υπηρεσιών που μας βοηθούν στη λειτουργία της ιστοσελίδας και της επιχείρησής μας.',

    rightsTitle: 'Τα Δικαιώματά σας',
    rightsDesc1:
      'Έχετε το δικαίωμα να αποκτήσετε πρόσβαση, να ενημερώσετε ή να διαγράψετε τα προσωπικά σας δεδομένα. Επικοινωνήστε μαζί μας για να ασκήσετε αυτά τα δικαιώματα.',
    rightsDesc2:
      'Μπορείτε να διακόψετε τη λήψη διαφημιστικών επικοινωνιών οποιαδήποτε στιγμή ακολουθώντας τον σύνδεσμο διαγραφής στα email μας.',

    ctaTitle: 'Έχετε Ερωτήσεις για το Απόρρητό σας;',
    ctaDesc:
      'Αν έχετε οποιαδήποτε ερώτηση σχετικά με αυτήν την Πολιτική Απορρήτου, παρακαλούμε επικοινωνήστε μαζί μας.',
