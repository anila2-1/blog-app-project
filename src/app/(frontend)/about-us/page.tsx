...
const translations = {
  ...
  el: {
    heroTitle: 'Σχετικά με το Ιστολόγιό μας',

    heroDesc:
      'Ανακαλύψτε εμπνευσμένες ιστορίες, διορατικά άρθρα και μια κοινότητα που αγαπά τη διάδοση γνώσεων και εμπειριών.',

    explore: 'Εξερεύνηση Άρθρων',
    ...
    missionP1:
      'Πιστεύουμε στη δύναμη των λέξεων να εμπνέουν, να εκπαιδεύουν και να ενώνουν ανθρώπους από κάθε κοινωνικό υπόβαθρο.',

    missionP2:
      'Είτε βρίσκεστε εδώ για να μάθετε κάτι νέο, να βρείτε έμπνευση ή απλώς να απολαύσετε ένα καλό ανάγνωσμα, έχουμε κάτι για όλους.',

    quality: 'Ποιοτικό Περιεχόμενο',

    qualityDesc: 'Προσεκτικά επιλεγμένα άρθρα που έχουν αξία',

    community: 'Κοινότητα στο Επίκεντρο',

    communityDesc: 'Δημιουργημένο από και για τους αναγνώστες μας',

    topics: 'Ποικιλία Θεμάτων',

    topicsDesc: 'Από την τεχνολογία έως τον τρόπο ζωής, τα καλύπτουμε όλα',

    joinTitle: 'Γίνετε Μέρος του Ταξιδιού μας',

    joinDesc:
      'Γίνετε μέλος μιας αναπτυσσόμενης κοινότητας συγγραφέων και αναγνωστών που μοιράζονται το πάθος για αφήγηση και μάθηση.',

    ctaTitle: 'Έτοιμοι να Ξεκινήσετε το Ταξίδι σας;',

    ctaDesc: 'Γίνετε ένας από τους χιλιάδες αναγνώστες που ανακαλύπτουν νέες ιδέες κάθε μέρα.',

    ctaBtn: 'Ξεκινήστε Σήμερα',
  },
}
