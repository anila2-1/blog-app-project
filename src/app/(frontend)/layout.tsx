...
export const metadata = {
  ...
  description:
    'Spoilers, περιλήψεις, τηλεοπτικές εκπομπές και πλήρη επεισόδια από τις αγαπημένες ελληνικές σειρές. Όλες οι εξελίξεις και το περιεχόμενο που αναζητάτε, συγκεντρωμένα σε ένα σημείο.',
}
