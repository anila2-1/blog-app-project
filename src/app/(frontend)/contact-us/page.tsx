...
const translations = {
  ...
  el: {
    ...
    heroDesc:
      'Θα χαρούμε να ακούσουμε νέα σας! Επικοινωνήστε μαζί μας για ερωτήσεις, σχόλια ή απλώς για να πείτε ένα γεια.',
    primaryBtn: 'Επικοινωνήστε',
    secondaryBtn: 'Δείτε το Ιστολόγιο',

    sectionTitle: 'Ελάτε σε Επαφή',
    sectionDesc1:
      'Έχετε κάποια ερώτηση, πρόταση ή απλώς θέλετε να συζητήσουμε; Συμπληρώστε την παρακάτω φόρμα και θα επικοινωνήσουμε μαζί σας.',
    sectionDesc2:
      'Εκτιμούμε τα σχόλιά σας και αναζητούμε πάντα τρόπους να βελτιώσουμε το ιστολόγιο και την κοινότητά μας.',

    feature1: 'Γρήγορη Απόκριση',
    feature1Desc: 'Απαντάμε εντός 24 ωρών',
    feature2: 'Προσωπική Υποστήριξη',
    feature2Desc: 'Αφοσιωμένοι στο να σας βοηθήσουμε',
    feature3: 'Παγκόσμια Εμβέλεια',
    feature3Desc: 'Συνδέοντας ανθρώπους σε όλο τον κόσμο',
    ...
    ctaTitle: 'Έτοιμοι να Συνδεθείτε;',
    ctaDesc:
      'Γίνετε μέλος της κοινότητάς μας και αρχίστε να μοιράζεστε τις ιδέες σας με όλο τον κόσμο.',
    ctaBtn: 'Εγγραφείτε Τώρα',
  },
}
